"""
Sources:
    https://github.com/yuliu625/Yu-AI-Inference-Manifests/blob/main/src/model_adapters/litserve_adapters/bge_m3.py

References:
    https://github.com/yuliu625/Yu-AI-Inference-Manifests/blob/main/src/model_adapters/native_encoding/flag_embedding/bge_m3.py
